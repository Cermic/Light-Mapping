...
void Game::initialise()
{
	...
	// Sceneobjects loaded
	box1 = new SceneObjects(vec3(-5.0f, 5.0f, -2.5f), vec3(1.0f, 1.0f, 1.0f),1.0f,"MetalBox.bmp","MetalBoxLightMapAdvanced.bmp");
	box2 = new SceneObjects(vec3(-8.0f, 5.0f, -2.5f), vec3(1.0f,1.0f,1.0f), 1.0f, "MetalBox.bmp");
	lightBox = new SceneObjects(light->getLightPos(), vec3(0.25f, 0.25f, 0.25f), "MetalBox.bmp");
}
...
void Game::update()
{
	...
	{
		box1->setTextures("MetalBox.bmp", "MetalBoxLightMapAdvanced.bmp");
	}
	// Loads MetalBox2 texture pair
	if (keys[SDL_SCANCODE_6])
	{
		box1->setTextures("MetalBox2.bmp", "MetalBox2LightMap.bmp");
	}
