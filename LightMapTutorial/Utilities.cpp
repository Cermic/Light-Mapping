...
void Utilities::loadUtilities()
	{
		...
		phongTextureProgram = rt3d::initShaders("phong-tex.vert", "phong-tex.frag");
		rt3d::setMaterial(phongTextureProgram, material0);
		//Phong texture setup

		lightMapProgram = rt3d::initShaders("lightmap.vert", "lightmap.frag");
		...
		cubeMapProgram = rt3d::initShaders("cubemap.vert", "cubemap.frag");
